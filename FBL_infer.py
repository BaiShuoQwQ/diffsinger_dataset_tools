...
def export(ckpt_path, wav_dir, tg_dir, tg_out_dir, ap_threshold=0.4, ap_dur=0.08, sp_dur=0.1):
    ...
    for tg_file in tqdm(tg_files):
        ...
        out_tg_path = tg_out_dir / f"{filename}.TextGrid"
        if wav_path.exists():
...
def main(ckpt_path, wav_dir, tg_dir, tg_out_dir, ap_threshold, ap_dur, sp_dur):
    export(ckpt_path, wav_dir, tg_dir, tg_out_dir, ap_threshold, ap_dur, sp_dur)
